...
#' 
#' > `Note:` You will have to change the path to the data file to the correct path on your machine.
#' 
## ----load_data----------------------------------------------------------------
...
reviews <- read_csv("../Data/turtle_reviews_2.csv")
...
#' 
#' > `NOTE:` Feel free to change the output directory to the directory you saved the Rmd file in.
...
# pagedown::chrome_print(input = "./Berni_Alberto_DA301_Assignment_RNotebook.Rmd", output = "./out/Berni_Alberto_DA301_Assignment_Notebook.pdf")

#' > `Note:` This will also generate an intermediate HTML file in the current `R` directory. This can be deleted.\
#' > `Note:` You can safely ignore the `[WARNING] Deprecated: --no-highlight. Use --syntax-highlighting=none instead.` warning.\
...
# rmarkdown::render("./Berni_Alberto_DA301_Assignment_RNotebook.Rmd", output_dir = "./out")
...
# knitr::purl("./Berni_Alberto_DA301_Assignment_RNotebook.Rmd", output = "./Berni_Alberto_DA301_Assignment_RScript.R", documentation = 2)
